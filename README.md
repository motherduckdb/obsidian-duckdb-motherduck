...
- **MotherDuck mode requires a local patch** — see `patches/` for the cross-origin worker fix. Will be removed once the [upstream PR](https://github.com/motherduckdb/mono/pull/15868) lands and a new `@motherduck/wasm-client` is released.
